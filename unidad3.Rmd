...
Los tres archivos a utilizar en la práctica contienen el mismo conjunto de datos de población de hombres y mujeres por entidad federativa y edad. La fuente de los datos es el [Censo de Población y Vivienda 2020 del INEGI]("https://www.inegi.org.mx/programas/ccpv/2020/"). 
...
2. Cree una nueva carpeta dentro del proyecto que se llame “datos” y ubique dentro de esta al archivo pob_censo_2020_inegi.txt.
...
5. En el script, utilizando el data table, programe el código correspondiente para resolver lo siguiente:
   ...
   5.47. Responda: ¿cuál es la media de edad a nivel nacional?
